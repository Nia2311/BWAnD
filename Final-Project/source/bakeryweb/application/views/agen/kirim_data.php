    ...
    <div class="alert alert-info bg-light my-5 ">
        <form action="<?= base_url(); ?>agen/tambahroti" method="POST">
            ...
            <div class="form-group row px-5 mt-3">
                <label for="jenisRoti" class="col-sm-4 col-form-label">
                    <h5>Jenis Roti</h5>
                </label>
                <div class="col-sm-8">
            ...
            <div class="form-group row px-5">
                <label for="roti" class="col-sm-4 col-form-label">
                    <h5>Nama Roti</h5>
                </label>
                <div class="col-sm-8">
            ...
            <div class="form-group row px-5">
                <label for="jumlahRoti" class="col-sm-4 col-form-label">
                    <h5>Jumlah Roti</h5>
                </label>
                <div class="col-sm-8">
                    <input type="number" class="form-control" id="jumlahRoti" name="jumlah" required>
                </div>
            </div>
