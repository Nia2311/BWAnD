			...
			<div class="text-center">
				<div class="card-header" style="background-color: #C69652;">
					<ul class="nav nav-tabs card-header-tabs">
						<li class="nav-item">
							<a class="nav-link" style="color:white; border-style: none;" href="<?php echo base_url(); ?>login_produksi">Produksi</a>
						</li>
				...
				<div class="card-body">
					<h2 class="card-title text-left" style="font-weight: 600;"> <span style="color: #C69652;"> |
						</span>LOGIN</h2>

					<form action="<?= base_url(); ?>login/proses_login_armada" method="POST">
